package com.example.mad_practical10_21012011010
...
class PersonAdapter(private val context: Context, private val array:
ArrayList<Person>): RecyclerView.Adapter<PersonAdapter.PersonViewHolder>(){
    inner class PersonViewHolder(val itemView: View):
    ...
    {val nameTxt : TextView = itemView.findViewById(R.id.txt_name)
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int):
                PersonViewHolder {
            val view =
                LayoutInflater.from(parent.context).inflate(R.layout.activity_person_name,
                    parent, false)
        ...
        override fun onBindViewHolder(holder: PersonViewHolder, position: Int) {
            ...
            holder.mapBtn.setOnClickListener {
                Intent(this@PersonAdapter.context,
                    MapsActivity::class.java).apply {
                    putExtra("Object",obj)
